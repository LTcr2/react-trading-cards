...
ReactDOM.render(
	<TradingCard name="Seedpy" skill="spitting seeds at all the haters" imgUrl="/static/img/seedpy.jpg" />, document.getElementById('seedpy')
);

ReactDOM.render(
	<TradingCard name="Merge" skill="meowing at git merge" imgUrl="/static/img/merge.jpg" />,
